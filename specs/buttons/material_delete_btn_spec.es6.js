const DeleteBtn = require("../../src/buttons/material_delete_btn");
...
describe('delete_btn', function() {
  ...
  describe('setIcon', function() {
    it("should default to size md-24", function() {
      expect(delete_btn.setIcon()).toEqual("material-icons md-24");
    });

    it("should set the size", function() {
      delete_btn.props.size =  "phil"
      expect(delete_btn.setIcon()).toEqual("material-icons phil");
    });
  });
  ...
  describe('check render', function() {
    ...
    describe('check Icon rendered ok', function() {
      componentHelper.checkRender(
        ...
        {
          attributes:[
            {key:"class", value:"material-icons md-24"}
          ],
          textNode:"delete"
        }
      );
